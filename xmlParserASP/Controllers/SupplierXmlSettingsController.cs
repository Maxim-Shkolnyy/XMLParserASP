...
namespace xmlParserASP.Controllers
{
    public class SupplierXmlSettingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SupplierXmlSettingId,SettingName,SupplierId,Path,StartGammaIDFrom,ProductNode,paramAttribute,ModelNode,ModelXlColumn,PictureNode,PictureXlColumn,imageNameInCatImg,PhotoFolder,QuantityNode,SupplierNode,ParamNode,ParamAttrNode")] SupplierXmlSetting supplierXmlSetting)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SupplierXmlSettingId,SettingName,SupplierId,Path,StartGammaIDFrom,ProductNode,paramAttribute,ModelNode,ModelXlColumn,PictureNode,PictureXlColumn,imageNameInCatImg,PhotoFolder,QuantityNode,SupplierNode,ParamNode,ParamAttrNode")] SupplierXmlSetting supplierXmlSetting)
        {
