...
namespace xmlParserASP.Controllers
{
    public class MmSupplierXmlSettingsController : Controller
    {
        ...
        {
            return View(await _context.MmSupplierXmlSettings.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("SupplierXmlSettingId,SettingName,SupplierId,Path,MainProductNode,ProductNode,ParamAttribute,ModelNode,ModelXlColumn,PriceNode,DescriptionNode,NameNode,CurrencyNode,PictureNode,PricePictureXlColumn,QuantityXlColumn,PhotoFolder,QuantityNode,QuantityDbStock1,QuantityDbStock2,QuantityDbStock3,QuantityDbStock4,QuantityDbStock5,QuantityDbStock6,QuantityDbStock7,QuantityDbStock8,QuantityDbStock9,QuantityLongTermNode,SupplierNode,ParamNode,ParamAttrNode,QtyInBoxColumnNumber,ExchangeRate,Markup")] MmSupplierXmlSetting mmSupplierXmlSetting)
        {
        ...
        {
            return _context.MmSupplierXmlSettings.Any(e => e.SupplierXmlSettingId == id);
        }
    }
}
