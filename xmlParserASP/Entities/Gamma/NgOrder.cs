...
public partial class NgOrder
{
    ...
    public DateTime ShippingDatetimeStart { get; set; }

    public DateTime ShippingDatetimeEnd { get; set; }

    public string ShippingCode { get; set; } = null!;

    public decimal ShippingCostFact { get; set; }

    public string ShippingStatusId { get; set; } = null!;

    public DateTime ShippingDate { get; set; }

    public TimeSpan ShippingTimeStart { get; set; }

    public TimeSpan ShippingTimeEnd { get; set; }
    ...
    public decimal OrderPresentCost { get; set; }

    public string OrderPresent { get; set; } = null!;

    public string OrderCustomFile { get; set; } = null!;

    public string OrderCustomImage { get; set; } = null!;
