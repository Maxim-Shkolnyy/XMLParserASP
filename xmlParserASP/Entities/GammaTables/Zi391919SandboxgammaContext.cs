...
public partial class Zi391919SandboxgammaContext : DbContext
{
    public Zi391919SandboxgammaContext()
    {
    }

    public Zi391919SandboxgammaContext(DbContextOptions<Zi391919SandboxgammaContext> options)
        : base(options)
    {
    }

    public virtual DbSet<MaxOurAttr> MaxOurAttrs { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySQL("Database=zi391919_sandboxgamma;Data Source=zi391919.mysql.tools;User Id=zi391919_sandboxgamma;Password=!6km4kKY_9;\n");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<MaxOurAttr>(entity =>
        {
            entity.HasKey(e => e.AttrId).HasName("PRIMARY");

            entity.ToTable("max_our_attr");

            entity.HasIndex(e => e.AttrId, "AttrId_UNIQUE").IsUnique();

            entity.Property(e => e.AttrId).HasColumnType("int(11)");
            entity.Property(e => e.AttrIdParrent).HasColumnType("int(11)");
            entity.Property(e => e.CatName).HasMaxLength(100);
            entity.Property(e => e.LangIndex).HasColumnType("int(11)");
        });
