        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityDbStock1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    QuantityDbStock2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    QuantityDbStock3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    QuantityDbStock4 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    QuantityDbStock5 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    QuantityDbStock6 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    QuantityDbStock7 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    QuantityDbStock8 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    QuantityDbStock9 = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Sku = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false),
                    SetInStockQty = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DateStart = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DateEnd = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
